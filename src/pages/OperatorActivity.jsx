            ...
            {isModalOpen && selectedDemand && (
                ...
                >
                    <div className="space-y-4">
                        ...
                        {(selectedDemand.customerName || selectedDemand.customerPhone) && (
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    {selectedDemand.customerName && (
                                        <div>
                                            ...
                                            <p className="text-gray-900 font-medium">{selectedDemand.customerName}</p>
                                        </div>
                                    )}
                                    {selectedDemand.customerPhone && (
                                        <div>
                                            ...
                                            <a
                                                href={`tel:${selectedDemand.customerPhone}`}
                                                className="text-green-600 hover:text-green-800 hover:underline font-semibold block"
                                            >
                                                {selectedDemand.customerPhone}
                                            </a>
                                        </div>
